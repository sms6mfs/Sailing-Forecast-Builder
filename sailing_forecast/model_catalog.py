...
OPEN_METEO_MODELS: tuple[WeatherModel, ...] = (
    ...
    WeatherModel("Meteo-France", "meteofrance_arpege_world", "Meteo-France ARPEGE world", "Global"),
    WeatherModel("Meteo-France", "meteofrance_arpege_europe", "Meteo-France ARPEGE Europe", "Europe"),
    WeatherModel("Meteo-France", "meteofrance_arome_france", "Meteo-France AROME France", "France region"),
    WeatherModel("Meteo-France", "meteofrance_arome_france_hd", "Meteo-France AROME France HD", "France region"),
